...
const aisles={
 ...
 'Snacks & sweets':[['Sweets & lollies','Lollies, Sweets & Licorice','Sweets, Lollies & Licorice'],['Chips'],['Chocolate','Chocolate Blocks','Chocolate Bars & Blocks'],['Snack bars','Muesli & Snack Bars','Muesli Bars & Snack Bars']],
 'Pantry':[['Breakfast cereal','Breakfast Cereals','Cereal'],['Rice'],['Pasta','Dried Pasta','Dried Pasta'],['Biscuits & Crackers'],['Flour'],['Sugar'],['Canned Tomatoes'],['Canned Tuna'],['Honey'],['Jam'],['Oats & Porridge']],
